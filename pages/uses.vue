<template>
  ...
  <ul class="list-disc">
    <li class="ml-8 py-1"><a href="https://code.visualstudio.com/" aria-label="WebStorm">WebStorm</a>
      is my current
  ...
  <img src="~/assets/images/phpstorm.png" alt="Visual Studio Code Synthwave 84 Theme" class="mt-8 mb-20" />
</template>